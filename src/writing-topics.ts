...
const TOPIC_RULES: Array<WritingTopic & { keywords: string[] }> = [
  ...
  { majorTopic: "科技", subtopic: "数字治理", keywords: ["数字治理", "数字政府", "数字化治理", "智慧城市", "数字赋能"] },
  { majorTopic: "科技", subtopic: "网络安全", keywords: ["网络安全", "数据安全", "信息安全", "个人信息"] },
  { majorTopic: "科技", subtopic: "数据发展", keywords: ["数据要素", "大数据", "数据发展", "数据资源"] },
  { majorTopic: "科技", subtopic: "产业升级", keywords: ["新质生产力", "智能制造", "产业升级", "科技产业"] },
  { majorTopic: "科技", subtopic: "科技创新", keywords: ["科技创新", "技术创新", "创新驱动", "科研", "科创"] },

  { majorTopic: "生态", subtopic: "低碳转型", keywords: ["双碳", "低碳", "碳达峰", "碳中和", "减排"] },
  ...
  { majorTopic: "生态", subtopic: "绿色发展", keywords: ["绿色发展", "绿色转型", "绿色产业", "循环经济", "生态"] },

  { majorTopic: "文化", subtopic: "文旅融合", keywords: ["文旅融合", "农文旅", "文化旅游", "旅游发展", "乡村旅游"] },
  { majorTopic: "文化", subtopic: "文化传承", keywords: ["文化传承", "传统文化", "非遗", "文化遗产", "历史文化"] },
  { majorTopic: "文化", subtopic: "文明建设", keywords: ["文明建设", "文明城市", "文明实践", "社会文明"] },
  { majorTopic: "文化", subtopic: "文艺传播", keywords: ["文艺", "文学", "影视", "文化传播", "网络文艺"] },
  { majorTopic: "文化", subtopic: "文化自信", keywords: ["文化自信", "文化强国", "中华文化", "文化软实力"] },

  { majorTopic: "经济", subtopic: "营商环境", keywords: ["营商环境", "政企服务", "市场主体", "企业服务"] },
  { majorTopic: "经济", subtopic: "就业人才", keywords: ["就业优先", "人才发展", "人才引进", "稳就业", "技能人才"] },
  { majorTopic: "经济", subtopic: "乡村振兴", keywords: ["乡村振兴", "三农", "农业发展", "农村经济", "共同富裕"] },
  { majorTopic: "经济", subtopic: "区域协调", keywords: ["区域协调", "城乡融合", "区域发展", "城市群"] },
  { majorTopic: "经济", subtopic: "消费发展", keywords: ["扩大内需", "消费", "文旅消费", "市场活力"] },
  { majorTopic: "经济", subtopic: "产业发展", keywords: ["产业发展", "实体经济", "民营经济", "经济发展", "产业链"] },

  { majorTopic: "政治", subtopic: "理论作风", keywords: ["实事求是", "理论学习", "作风建设", "调查研究", "求真务实"] },
  { majorTopic: "政治", subtopic: "改革创新", keywords: ["深化改革", "改革创新", "首创精神", "体制机制", "破立并举"] },
  { majorTopic: "政治", subtopic: "干部担当", keywords: ["干部担当", "担当作为", "干事创业", "向前一步", "履职尽责"] },
  { majorTopic: "政治", subtopic: "党建引领", keywords: ["党建引领", "党群服务", "基层党建", "党组织", "党员"] },
  { majorTopic: "政治", subtopic: "法治建设", keywords: ["依法行政", "法治建设", "法治政府", "执法", "普法"] },
  { majorTopic: "政治", subtopic: "基层治理", keywords: ["基层治理", "治理能力", "群众路线", "共建共治", "治理体系"] },

  { majorTopic: "社会", subtopic: "社区服务", keywords: ["社区服务", "惠民服务", "社区工作", "便民服务", "服务群众"] },
  { majorTopic: "社会", subtopic: "城市治理", keywords: ["人民城市", "城市治理", "城市更新", "人才与城市", "城市发展"] },
  { majorTopic: "社会", subtopic: "教育发展", keywords: ["教育发展", "干部教育", "职业教育", "学校教育", "教育公平"] },
  { majorTopic: "社会", subtopic: "民生保障", keywords: ["民生保障", "养老", "医疗", "社会保障", "困难群众"] },
  { majorTopic: "社会", subtopic: "青年成长", keywords: ["青年成长", "青春", "青年干部", "青年人才", "大学生"] },
  { majorTopic: "社会", subtopic: "公共服务", keywords: ["公共服务", "政务服务", "为民服务", "服务供给", "基本公共"] },
];
